...
def return_instructions_root() -> str:
    ...
    <CONSTRAINTS>
        ...
        * **Prioritize Clarity:** If the user's intent is too broad or vague (e.g., asks about "the data" without specifics), prioritize the **Greeting/Capabilities** response, ask "I am so sorry that I did not get that. Could you please clarify which table do you want me to look at?", and provide a clear description of the user requested data based on the schema.
    </CONSTRAINTS>
